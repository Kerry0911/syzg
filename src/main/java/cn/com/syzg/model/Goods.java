...
public class Goods implements Serializable {
    private static final long serialVersionUID = -8515584940412091378L;
    /**
     *
    ...
    public Goods(Integer goodsid, String goodsname, String detail, byte[] image) {
        this.goodsid = goodsid;
    ...
    public Goods(String goodsname, String detail, byte[] image) {
        this.goodsname = goodsname;
        this.detail = detail;
        this.image = image;
    }
